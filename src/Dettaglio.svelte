<script>
    ...
    onMount(async()=>{
      console.log("montato")
      const result=await axios.get("http://localhost:8090/projectwork/rest/opera/findAllById")
      console.log(result);
    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/5 mx-auto flex flex-wrap">
        <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
          ...
          <h1 class="text-gray-900 text-3xl title-font font-medium mb-4">{opera.titolo}</h1>
          <h2 class="text-sm title-font text-gray-500 tracking-widest">{opera.artista}</h2>
          <div class="flex mb-4">
            <span class="flex-grow text-yellow-500 border-b-2 border-yellow-500 py-2 text-lg px-1">Description</span>
          </div>
          <p class="leading-relaxed mb-4">{opera.descrizione}</p>
